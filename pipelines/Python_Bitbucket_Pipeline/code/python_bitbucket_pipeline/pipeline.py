...
def main():
    ...
    try:
        ...
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/Python_Bitbucket_Pipeline", config = Config)
    except :
        
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/Python_Bitbucket_Pipeline")
